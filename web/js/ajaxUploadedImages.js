        ...
        success: function (data) {
            ...
            for(i=0; i<data.data.length; i++){
                ...
                modal +=
                    ...
                    "            <div class=\"modal-content bg-primary border-0 text-light\" style=\"background-color: rgb(255,227,232) !important\">\n" +
                    ...
                    "                            </div>\n" +
                    "                            <p style=\"color: rgb(104,88,91)\">Are you sure to remove this picture?</p>\n" +
            ...
            if(data.data.length>0) {
                ...
                uploadedPages +=
                    "<div class=\"container\" id=\"collectedImages\" style=\"margin-bottom: 25rem\">    <div class=\"decoration-check mb-4\">\n" +
                    ...
                    "        <h5 class=\"mb-1\">Your have not uploaded any picture yet, upload your first picture!</h5>\n" +
                    "    </div></div>";
            }
